...
<div class="plugins-accounts-wrapper aiform-base-ui-wrapper">
    ...
    <div class="plugins-accounts-info">
        <div class="left-sec-wrap">
            ...
            <ul>
                <li><a href="#" class="menu-link-info active" data-target="tabs-1">Ai Form </a></li>
            </ul>
        </div>
...
<script>
    $(document).ready(function(){
      $(".loaderoverlay").fadeIn(300);
        $.ajax({
            url: "<?php echo $apiUrl;?>get-ai-category",
            type:'Get',
...
function getPrompt(){
  ...
  $.ajax({
  url: "<?php echo $apiUrl;?>get-prompt-ai",
  type: 'Get',
  beforeSend: function (xhr) {  
              xhr.setRequestHeader("secertkey","<?php echo $secertkey;?>" );
              xhr.setRequestHeader("openai", "<?php echo $openAi;?>");
...
function checkBoxPrompt(){
    $(".category-check-box").change(function() {
                 ...
                 $.ajax({
                    url: "<?php echo $apiUrl;?>check-box-filter-ai",
                    type: 'Post',
                    beforeSend: function (xhr) {  
                                xhr.setRequestHeader("secertkey","<?php echo $secertkey;?>" );
                                xhr.setRequestHeader("openai", "<?php echo $openAi;?>");
...
function searchPrompt(){   
  ...
  $.ajax({
                    url: "<?php echo $apiUrl;?>search-prompt-ai",
                    type: 'Post',
                    beforeSend: function (xhr) {  
                                xhr.setRequestHeader("secertkey","<?php echo $secertkey;?>" );
                                xhr.setRequestHeader("openai", "<?php echo $openAi;?>");
...
function promptBaseId(){
        ...
        $(".promptBaseId").click(function(){
          $(".loaderoverlay").fadeIn(300);
            ...
            $.ajax({
                    url: "<?php echo $apiUrl;?>search-by-id-ai",
                    type: 'Post',
                    beforeSend: function (xhr) {  
                                xhr.setRequestHeader("secertkey","<?php echo $secertkey;?>" );
                                xhr.setRequestHeader("openai", "<?php echo $openAi;?>");
...
<script>
    ...
    $("#generatePromptBase").click(function(){
      ...
      $.each(promptTextTitle, function( fieldsIndex, fieldsValue ) {
        ...
        $.ajax({
                    url: "<?php echo $apiUrl;?>prompt-base-ai",
                    type: 'Post',
                    beforeSend: function (xhr) {  
                                xhr.setRequestHeader("secertkey","<?php echo $secertkey;?>" );
                                xhr.setRequestHeader("openai", "<?php echo $openAi;?>");
